...
public class CronExpressionBuilder implements CronExpression {
	...
	private class HourContextBuilder implements HourContext {
		...
		@Override
		public IExpression at(Hour hour, Minute minute) {
			...
			return expression.setHour(String.valueOf(hour.getValue())).setMinute(String.valueOf(minute.getValue()));
		}
	}
